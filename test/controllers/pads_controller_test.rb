...
class PadsControllerTest < ActionController::TestCase
  ...
  test "should create pad" do
    assert_difference('Pad.count') do
      post :create, pad: { body: @pad.body, external_url: @pad.external_url, heading: @pad.heading, price: @pad.price }
    end
  ...
  test "should update pad" do
    patch :update, id: @pad, pad: { body: @pad.body, external_url: @pad.external_url, heading: @pad.heading, price: @pad.price }
    assert_redirected_to pad_path(assigns(:pad))
  end
